...
export class ContentCreditsComponent implements OnInit, OnChanges {
  ...
  ngOnChanges() {
    ...
    if (this.contentData) {
      ...
      const contentCredits:any = _.get(this.contentData, 'contentCredits');
      ...
      if (_.get(this.contentData, 'attributions')) {
        ...
        (_.get(this.contentData, 'attributions')as unknown as string).split(',') : _.get(this.contentData, 'attributions');
